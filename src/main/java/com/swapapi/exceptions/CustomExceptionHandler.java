...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler({ com.swapapi.exceptions.ResourceNotFoundException.class })
    public ResponseEntity<Object> handleEntityNotFoundException(com.swapapi.exceptions.ResourceNotFoundException ex, WebRequest request) {
	...
	@ExceptionHandler({ com.swapapi.exceptions.DuplicatedResourceException.class })
    public ResponseEntity<Object> handleDuplicatedEntityException(com.swapapi.exceptions.DuplicatedResourceException ex, WebRequest request) {
